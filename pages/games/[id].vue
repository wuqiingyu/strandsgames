    ...
    <div v-else-if="gameData" class="content">
      <div class="details">
        ...
        <div class="play_game">
          <!-- 左侧广告位 game-pc1 -->
          <div class="left_game">
            <AdSense ad-slot="4600591886" ad-format="fixed" style="width:160px;height:600px;display:block" />
          </div>
          ...
          <div class="play">
            ...
            <div class="bottom-ad-unit">
              ...
              <div class="desktop-only">
                <AdSense ad-slot="3144403627" ad-format="rectangle" style="width:728px;height:188px;display:block" />
              </div>
              <!-- 移动端广告 -->
              <div class="mobile-only">
                <AdSense ad-slot="5649767486" ad-format="auto" style="display:block" />
              </div>
            </div>
          </div>
          ...
          <div class="right_game">
            <AdSense ad-slot="7237363083" ad-format="fixed" style="width:160px;height:600px;display:block" />
          </div>
        </div>
        ...
        <div class="bottom_game">
          ...
          <div class="more-games-section">
            ...
            <div class="mobile-bottom-ad">
              <AdSense ad-slot="3365566683" ad-format="auto" style="display:block" />
            </div>
          </div>
...
watchEffect(() => {
  if (gameData.value) {
    ...
    const jsonLd = {
      ...
      "@type": "VideoGame",
      "name": gameData.value.app_name,
      "description": gameData.value.summary || `Play ${gameData.value.app_name} online game for free. Compatible with mobile, tablet and desktop devices.`,
      "image": gameData.value.icon_url,
      "url": `https://blrssco.com/games/${appName}`,
      "genre": gameData.value.category || "Casual Game",
      ...
      "aggregateRating": gameData.value.rating ? {
        "@type": "AggregateRating",
        "ratingValue": gameData.value.rating,
        "ratingCount": gameData.value.installs || "1000"
      } : undefined,
      "datePublished": gameData.value.created_at || new Date().toISOString(),
      "keywords": `${gameData.value.app_name}, online game, mobile game, ${gameData.value.category || 'games'}, browser game, free game`
    }
    ...
    useHead({
      ...
      meta: [
        ...
        { property: 'og:url', content: `https://blrssco.com/games/${appName}` },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: `${gameData.value.app_name} - Play Online Game` },
        { name: 'twitter:description', content: gameData.value.summary || `Play ${gameData.value.app_name} online for free` },
        { name: 'twitter:image', content: gameData.value.icon_url }
      ],
      link: [
...
const userOrientation = ref(null)
